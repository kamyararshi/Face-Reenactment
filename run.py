...
if __name__ == "__main__":
    ...
    parser.add_argument("--no_mixed_precission", dest="mixed_precission", action="store_false", help="Does not use mixed precision")
    parser.add_argument("--verbose", dest="verbose", action="store_true", help="Print model architecture")
    parser.set_defaults(mixed_precission=True)
